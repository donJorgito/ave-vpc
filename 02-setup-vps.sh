...
echo ""
echo "IMPORTANTE si usas Oracle Cloud:"
echo "  Abre los puertos ${MLVPN_PORT_1}/UDP y ${MLVPN_PORT_2}/UDP"
echo "  en las Security Lists de tu VCN"
echo "  (Networking > Virtual Cloud Networks > tu VCN > Security Lists > Ingress Rules)"
echo ""
